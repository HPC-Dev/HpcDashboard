...
public interface AverageResultRepo extends DataTablesRepository<AverageResult, AverageResultId> {
    ...
    public static final String UPDATE_AVG_RESULT = "UPDATE average_result set avg_result=:avg,per_core_perf=:perCorePerf, coefficient_of_variation=:cv, run_count=:count where bm_name=:bm_name and cpu_sku =:cpu_sku and nodes=:nodes and run_type=:runType";
    ...
    void updateAverageResult(String bm_name, String cpu_sku, int nodes, double avg,double perCorePerf, double cv, int count, String runType);
